...
const char *WINDOWTITLE = "CS 457 Project #1 -- Annette Tongsak";
...
Display( )
{
	...
	Pattern.SetUniformVariable("uAd", 0.5f);
	Pattern.SetUniformVariable("uBd", 0.5f);
	Pattern.SetUniformVariable("uTol", 0.f);
...
InitLists( )
{
	...
	glNewList( DragonList, GL_COMPILE );
		LoadObjFile((char*)"dragon138.obj");
	glEndList( );
